...
export default function RecipeStepsInput({register, errors, fields, append, remove, identifier = "", watch = null}) {
    ...
    return (
        <>
                    ...
                    <div className="bg-slate-200 rounded-lg">
                        ...
                        <div className="flex gap-1 w-full" key={field.id}>
                            <textarea
                                ...
                                bg-slate-300 text-blue-1 font-semibold font-poppins rounded-lg py-2 px-3' 
            ...
            <div>
                <button type='button' onClick={() => append("")} className='float-right w-36 font-poppins font-semibold bg-slate-300 text-blue-1 rounded-lg hover:opacity-90 cursor-pointer px-4 py-2'>
