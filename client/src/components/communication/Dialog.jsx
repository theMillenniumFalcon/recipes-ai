            ...
            <div className="flex flex-col justify-center items-center h-full gap-3 overflow-auto">    
                {
                    ...
                    <div className="bg-white shadow-shadow-2 h-32 min-w-[275px] max-w-[80vw] rounded-xl flex justify-center items-center gap-3 px-6 py-3">
...

                {
                    ...
                    <div className="flex flex-col justify-center items-center h-full gap-3">
                        ...
                        <SignedIn>
                            <div className='text-blue-1 bg-white p-5 rounded md:max-w-[50vw] font-poppins'>
...

                {
                    ...
                    <div className="bg-white min-w-[200px] max-w-[90vw] md:max-w-[50vw] lg:[30vw] rounded-xl flex flex-col justify-center items-center gap-3 px-6 py-3">
                        ...
                        <div className='flex gap-1 font-semibold font-poppins'>
                            <button type='button' onClick={() => close(true)} className='bg-slate-300 text-blue-1 rounded-lg hover:opacity-90 cursor-pointer px-7 py-2'>
                                Yes
                            </button>
