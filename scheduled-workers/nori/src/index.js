...
export default {
    async scheduled(controller, env, ctx) {
        try {
            ...
            await actionsObj.cleanSuccessLogs(collection, (24 * 60 * 60 * 1000)) // olderThan = 1 day
            await actionsObj.cleanHangingImages(collection, (24 * 60 * 60 * 1000), env) // olderThan = 1 day
            await actionsObj.cleanUnsuccessfulLogs(collection, (30 * 24 * 60 * 60 * 1000)) // olderThan = 1 month
